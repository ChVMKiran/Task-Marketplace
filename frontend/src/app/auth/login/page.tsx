    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 relative z-10 bg-white">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="w-full max-w-sm">
          ...
          <p className="text-sm text-neutral-500 mb-8 font-medium">Sign in to your account to continue</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="text-sm font-semibold text-black mb-1.5 block">Email</label>
          ...
          <p className="text-sm text-neutral-500 text-center mt-8 font-medium">
            Don&apos;t have an account?{" "}
            <Link href="/auth/signup" className="text-black hover:underline font-bold">Sign up</Link>
          </p>
        </motion.div>
      </div>
